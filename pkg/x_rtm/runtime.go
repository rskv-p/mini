...
type Runtime interface {
	...
	Execute(action typ.IAction) (any, error) // Execute the action in the runtime.
...
func (c *Client) ExecuteAction(action typ.IAction) (any, error) {
...
func (r *ExecRuntime) Execute(action typ.IAction) (any, error) {
...
func (r *GoRuntime) Execute(action typ.IAction) (any, error) {
...
func executeGoFunction(funcName string, action typ.IAction) (any, error) {
	// Here we can map Go function names to actual Go function calls.
	goFuncs := map[string]func(typ.IAction) (any, error){
...
func exampleFunction(action typ.IAction) (any, error) {
...
func (m *RuntimeModule) ExecuteAction(runtimeName string, action *act.Action) (any, error) {
