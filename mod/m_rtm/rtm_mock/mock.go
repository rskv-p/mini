...
type MockRuntime struct {
	...
	CalledWith  act_type.IAction // Last action passed to Execute()
}

// Ensure interface compliance
var _ rtm_core.Runtime = (*MockRuntime)(nil)
...
func (m *MockRuntime) Execute(action act_type.IAction) (any, error) {
	m.CalledWith = action
